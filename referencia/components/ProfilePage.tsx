...
import { Bookmark, Clock, Heart, Award, Zap, ChevronRight, BookOpen, BookMarked, Users, Pause, PlayCircle, X, Camera, Image as ImageIcon, AlignLeft, Upload, Lock, Unlock, User as UserIcon, Key, Info, Sparkles } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 md:px-0">
          ...
          <div className="relative w-full max-w-2xl bg-zinc-900 border border-zinc-800 rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-8 space-y-8 max-h-[75vh] overflow-y-auto custom-scrollbar">
              ...
              {/* Account Basic Info (Username & Password) */}
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-4 px-5 text-white focus:outline-none focus:border-cyan-500 transition-all text-sm"
                  />
                </div>
              </div>
