        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Explorar Mangas</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Últimos Capítulos</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Directorio de Scans</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Ranking Semanal</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white font-bold mb-6">Para Scans</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Registrar mi Scan</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Guía de Publicación</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">API para Scans</a></li>
              <li><a href="#" className="text-zinc-500 hover:text-cyan-400 text-sm transition-colors">Soporte Técnico</a></li>
            </ul>
          </div>
