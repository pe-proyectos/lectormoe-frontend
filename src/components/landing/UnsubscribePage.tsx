...
import { BellOff, CheckCircle, XCircle, ArrowRight } from 'lucide-react'
...
const UnsubscribePage: React.FC<UnsubscribePageProps> = ({ success, message }) => {
  return (
            ...
            <div className="flex flex-col items-center animate-in zoom-in duration-300">
              ...
              {success && (
                <p className="text-zinc-600 text-xs leading-relaxed mb-8">
                  Puedes volver a activar las notificaciones en cualquier momento desde tu configuracion.
                </p>
              )}
            </div>
