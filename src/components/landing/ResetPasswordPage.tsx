    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-20 pb-12 relative overflow-hidden bg-zinc-950">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-500">
        ...
        <p className="mt-8 text-center text-zinc-600 text-[10px] uppercase tracking-widest leading-relaxed">
          Al continuar, aceptas nuestros <a href="#" className="text-zinc-400 hover:text-white underline underline-offset-4">Terminos de Servicio</a> y <a href="#" className="text-zinc-400 hover:text-white underline underline-offset-4">Politica de Privacidad</a>.
        </p>
      </div>
    </div>
  )
