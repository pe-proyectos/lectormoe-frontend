...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ page, organizationSlug }) => {
  ...
  return (
    <aside className="sticky top-16 md:top-[72px] h-[calc(100vh-64px)] md:h-[calc(100vh-72px)] w-full max-w-[280px] border-r border-zinc-800 bg-zinc-950/50 overflow-y-auto">
