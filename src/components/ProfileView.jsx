  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center pt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center text-center">
              <img
                ...
                src={
                  member.imageUrl ||
                  "https://i.pinimg.com/736x/0f/8b/73/0f8b739199c93a036ff8fab7a00c5caf.jpg"
                }
                alt={username}
              />
        ...
        <div className="w-full max-w-6xl grid grid-cols-3 gap-4 p-5">
