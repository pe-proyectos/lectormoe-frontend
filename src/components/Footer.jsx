        ...
        <footer className="relative w-full">
            <div className="mx-auto w-full max-w-7xl px-8">
                <div className="mt-2 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                    <p className="text-sm text-gray-600 mb-4 text-center font-normal md:mb-0">
                        &copy; {currentYear} <a href="/">{organization?.name}</a>.
                        {" "}{_("all_rights_reserved")}
                    </p>
                    <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
                        {organization?.facebookUrl && (
                            <a href={organization?.facebookUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-blue-600">
                        ...
                        {organization?.instagramUrl && (
                            <a href={organization?.instagramUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-pink-600">
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path
                                        fillRule="evenodd"
                        ...
                        {organization?.twitterUrl && (
                            <a href={organization?.twitterUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-blue-600">
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        {organization?.youtubeUrl && (
                            <a href={organization?.youtubeUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-red-600">
                        ...
                        {organization?.patreonUrl && (
                            <a href={organization?.patreonUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-orange-600">
                                <svg
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    className="w-5 h-5"
                        ...
                        {organization?.discordUrl && (
                            <a href={organization?.discordUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-indigo-600">
                                <svg fill="currentColor" className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        {organization?.tiktokUrl && (
                            <a href={organization?.tiktokUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-teal-600">
                                <svg
                                    viewBox="0 0 448 512"
                                    fill="currentColor"
                                    className="w-5 h-5"
                        ...
                        {organization?.twitchUrl && (
                            <a href={organization?.twitchUrl} target="_blank" className="opacity-80 transition-opacity hover:opacity-100 text-purple-600">
                                <svg
                                    fill="currentColor"
                                    viewBox="0 0 16 16"
                                    className="w-5 h-5"
