...
const ScanHero: React.FC<ScanHeroProps> = ({ mangas }) => {
    ...
    <section className="relative h-[450px] md:h-[650px] w-full overflow-hidden">
      ...
      <div className="absolute bottom-12 left-0 right-0 z-20">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="relative bg-zinc-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-5 md:p-6 max-w-2xl shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <button className="bg-zinc-950/80 text-green-500 border border-green-500/50 px-5 py-2 rounded-lg font-black text-[9px] uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                  LEER AHORA
                </button>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                  <span className="text-white text-[10px] font-bold">En emisión</span>
                </div>
              </div>
              ...
              <div className="px-3 py-1 bg-zinc-800 rounded-lg text-white text-[9px] font-black uppercase tracking-widest border border-white/5">
                {currentFeatured.genres?.[0] || 'SEINEN'}
              </div>
            </div>
          </div>
